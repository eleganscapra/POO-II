public class Circulo { // 1
    ...
    // Prueba 1 (ejercicio 2): sin ningun objeto creado, el codigo compila pero no devuelve nada, pues no se indico nada.
...
class CirculoTest{
    ...
    // respuesta de la ultima pregunta del ejercicio 3: lo que tienen en comun es la creacion de un objeto, pues si no hay objeto no se puede hacer uso de sus metodos
    ...
    public static void main(String[] args) {
        ...
        // j. this funciono como indicador de un nombre, imaginemos que se usan muchos nombres de variables, y para no confundirlos entre metodos.
